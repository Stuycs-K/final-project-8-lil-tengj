...
PImage StripedBlueH;
PImage StripedBlueV;
PImage StripedGreenH;
PImage StripedGreenV;
PImage StripedOrangeH;
PImage StripedOrangeV;
PImage StripedPurpleH;
PImage StripedPurpleV;
PImage StripedRedH;
PImage StripedRedV;
PImage StripedYellowH;
PImage StripedYellowV;
int count;
Candy powerC;
...
void setup() {
  ...
  CCMenu = loadImage("StartingBG.jpg");
  CCMenu.resize(width, height);
  blueC = loadImage("BluecandyHTML5.png");
  blueC.resize(SQUARE_SIZE, SQUARE_SIZE);
  redC = loadImage("RedcandyHTML5.png");
  redC.resize(SQUARE_SIZE, SQUARE_SIZE);
  orangeC = loadImage("OrangecandyHTML5.png");
  orangeC.resize(SQUARE_SIZE, SQUARE_SIZE);
  yellowC = loadImage("YellowcandyHTML5.png");
  yellowC.resize(SQUARE_SIZE, SQUARE_SIZE);
  colourBomb = loadImage("colorfulCandy.png");
  colourBomb.resize(SQUARE_SIZE, SQUARE_SIZE);
  greenC = loadImage("GreencandyHTML5.png");
  greenC.resize(SQUARE_SIZE, SQUARE_SIZE);
  purpleC = loadImage("PurplecandyHTML5.png");
  purpleC.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedBlueH = loadImage("Striped_blue_h.png");
  StripedBlueH.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedBlueV = loadImage("Striped_blue_v.png");
  StripedBlueV.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedGreenH = loadImage("Striped_green_h.png");
  StripedGreenH.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedGreenV = loadImage("Striped_green_v.png");
  StripedGreenV.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedOrangeH = loadImage("Striped_orange_h.png");
  StripedOrangeH.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedOrangeV = loadImage("Striped_orange_v.png");
  StripedOrangeV.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedPurpleH = loadImage("Striped_purple_h.png");
  StripedPurpleH.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedPurpleV = loadImage("Striped_purple_v.png");
  StripedPurpleV.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedRedH = loadImage("Striped_red_h.png");
  StripedRedH.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedRedV = loadImage("Striped_red_v.png");
  StripedRedV.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedYellowH = loadImage("Striped_yellow_h.png");
  StripedYellowH.resize(SQUARE_SIZE, SQUARE_SIZE);
  StripedYellowV = loadImage("Striped_yellow_v.png");
  StripedYellowV.resize(SQUARE_SIZE, SQUARE_SIZE);

  levelwin = new SoundFile(this, "levelwin.wav");
...
void keyPressed() {
  if (MODE == 0) {
    ...
    if (key == '1') {
      ...
      StripedYellowV = loadImage("Striped_yellow_v.png");
      StripedYellowV.resize(SQUARE_SIZE, SQUARE_SIZE);
      crushP = new Panel((height -25)/ SQUARE_SIZE, (width -25)/SQUARE_SIZE, (int)(Math.random()*20 + 50), new Candy(type[(int)(Math.random()*6)], "powerless"));
    }
...
void draw() {
  ...
  if (MODE ==1 || MODE ==4 ) {
    ...
    if (crushP.one.passLevel()) {
      ...
      text("press 'r' to return to main!", 290, 320);
    }
  }
}
